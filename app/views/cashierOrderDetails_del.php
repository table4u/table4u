          ...
          <input type="text" placeholder="Search.." name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search'];}?>">
            ...
            <div class="btns">
                <div class="grid-container-customer">
                    ...
                    <a class="grid-item"  href="<?php echo URLROOT ?>/CashierOrderMenu/showOrderDetailsCompleted">Finished</a>
                    <a class="grid-item"  id="clickedBtn"href="<?php echo URLROOT ?>/CashierOrderMenu/showOrderDetailsDeleted">Cancelled</a>
                </div>
            </div>
