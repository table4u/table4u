...
document.querySelector('#Add_new_employee_btn').addEventListener('click',()=>{
    window.location.href = 'RestaurantManagerEmployee/addNewEmp'
});

$.ajax({
    type:'POST',
    url:"../gp1/RestaurantManagerHome/getDatareservation",
